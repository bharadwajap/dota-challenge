...
public class MatchServiceImpl implements MatchService {
	...
	private static final String [] EVENTS = {"buys", "killed", "casts", "hits"};
	...
	public List<HeroDamage> getDamage(Long matchId, String heroName) {
		...
		if(CollectionUtils.isEmpty(damageTuples))
			throw new ResourceNotFoundException("Damages", matchId +" & "+ heroName);
	...
	public List<HeroKills> getKills(Long matchId) {
		...
		if(CollectionUtils.isEmpty(killTuples))
			throw new ResourceNotFoundException("Kills", matchId);
	...
	public List<HeroItems> getItems(Long matchId, String heroName) {
		...
		if(CollectionUtils.isEmpty(itemTuples))
			throw new ResourceNotFoundException("Items", matchId +" & "+ heroName);
	...
	public List<HeroSpells> getSpells(Long matchId, String heroName) {
		...
		if(CollectionUtils.isEmpty(spellTuples))
			throw new ResourceNotFoundException("Spells", matchId +" & "+ heroName);
